    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={heroImage} 
            alt="Personas disfrutando de actividades de bienestar" 
        ...
        <div className="container relative z-10 mx-auto px-4 py-20">
          <div className="max-w-4xl mx-auto text-center text-white animate-slide-up">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed">
              Un taller único que combina <strong>creatividad</strong>, <strong>risoterapia</strong> y <strong>coaching ontológico</strong> 
              para transformar tu relación con el estrés diario y garantizar tu bienestar integral
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button 
                size="lg" 
                className="bg-white text-primary hover:bg-accent hover:text-primary-foreground transition-smooth shadow-soft text-lg px-8 py-4"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 animate-bounce-in" style={{ animationDelay: '0.1s' }}>
                <div className="text-3xl mb-2">⏰</div>
                <p className="font-semibold">Horario</p>
                <p className="text-accent">Miércoles 19-20:30</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 animate-bounce-in" style={{ animationDelay: '0.2s' }}>
                <div className="text-3xl mb-2">👥</div>
