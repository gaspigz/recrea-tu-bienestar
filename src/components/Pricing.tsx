    ...
    <section className="py-20 gradient-warm">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 flex flex-col sm:flex-row justify-center items-center gap-4 w-full">
          ...
          {/* Botón 2: Descargar Programa PDF */}
          <a href="/ProgramaBienestar2026.pdf" download="Programa_Bienestar_2026.pdf" className="w-full sm:w-auto">
            <Button variant="outline" className="w-full border-primary text-primary hover:bg-primary hover:text-white transition-all">
              <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Botón 3: WhatsApp */}
          <a href="https://wa.me/TU_NUMERO_ACA" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
