...
{/* Botón 2: Consultas por WhatsApp */}
  <a 
    href="https://wa.me/tu-numero" 
    target="_blank" 
    rel="noopener noreferrer"
  >
    <Button variant="outline" className="border-success text-success hover:bg-success hover:text-white transition-all">
